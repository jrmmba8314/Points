...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("local.jrmmba.points"))
    ...
    {
        return new ApiInfoBuilder().title("Points")
                .description("Fetch Rewards Coding Exercise - Backend Software Engineering")
                .contact(new Contact("John Mitchell",
                        "https://github.com/jrmmba8314",
                        "jrmmba@outlook.com"))
                .license("MIT")
                .licenseUrl("https://github.com/jrmmba8314/Points/blob/main/LICENSE")
                .version("1.0.0")
                .build();
    }
}